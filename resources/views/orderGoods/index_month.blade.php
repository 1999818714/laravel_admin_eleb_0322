...
@section('contents')
    @include('_errors')
    <form action="{{ route('orderGoods.index_month') }}" class="navbar-form navbar-left" method="get">
        <a href="{{ route('orderGoods.index_day') }}" class="btn btn-primary" role="button">按日统计</a>
        <a href="{{ route('orderGoods.index') }}" class="btn btn-primary" role="button">按商家统计</a>
