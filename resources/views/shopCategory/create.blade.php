...
@section('contents')
<form class="form" method="post" action="{{ route('shopCategory.store') }}" enctype="multipart/form-data">
    <h1 class="container">添加商家分类页面</h1>
    @include('_errors')
    ...
    <div class="input-group">
        ...
        显示<input type="radio" value="1" checked name="status" aria-describedby="basic-addon1">
        隐藏<input type="radio" value="0" name="status" aria-describedby="basic-addon1">
    </div><br>
    {{ csrf_field() }}
